...
│   └── contollers/       # Элементы управления (газ и т.д.)
...
| `gearRatio`       | `computed`            | Передаточное отношение: N=0, 1=4, 2=3, 3=2, 4=1. Влияет на макс. скорость.       |
