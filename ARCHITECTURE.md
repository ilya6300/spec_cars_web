...
| ------------------ | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| `CarStore`         | Класс (`makeAutoObservable`) | Физика автомобиля: разгон/торможение, расход топлива, текущая/макс. скорость, зажигание (`isIgnitionOn`), вращение колёс (`wheelRotation`). |
| `MapStore`         | Класс (`makeAutoObservable`) | Состояние карты: позиция прокрутки, коллизии, смена уровней.                                                                                |
